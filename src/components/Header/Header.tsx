...
import { selectBasketItems, selectTotalPrice } from "../../store/basket/BasketSelector";
...
export const Header: React.FC = () => {
  ...
  return (
    <header className={styles.root}>
      <Link to="/">
        <img alt="logo" width="80" src={logo1} />
      </Link>
      <nav className={styles.menu}>
        <Link to="/restaurants">Menu</Link>
        <Link to="/restaurants">About</Link>
        <Link to="/restaurants">Log In</Link>
        <Link to="/basket">Basket</Link>
        </nav>
        <div className={styles.info}>
        <img alt="logo" width="50" src={profileIcon} />
